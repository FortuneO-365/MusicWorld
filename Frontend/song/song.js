...
async function fetchSongFromSearch(id){
    ...
    if(data.SPOTIFY){
        ...
        majorDetails.innerHTML = `
            <div>
                <audio id="audio" src=${songInfo.songUrl || ''}></audio>
            </div>
            <div id="song-description">
                ...
                <p id="description" class="items active">
                    ${songInfo.description || 'Song Description is unavailable at the moment.'}
                </p>
                <p id="lyrics" class="items">
                    ${songInfo.lyrics || 'Song Lyrics is unavailable at the moment.'}
                </p>
            </div>
            ${localStorage.getItem('user') != null ? 
                `<div id="download-button">
                    <a id="download" href=${songUrl || ''} download="${songInfo.name} preview">
                        <div>
                            Download Song
                        </div>
                        <span>
        ...
        `;
        minorDetails.innerHTML = `
            <div id="song-img">
                <img src=${songInfo.album.images[0].url} alt="" id="song-image">
            </div>
            <div id="minor-details-deets">
                <h2 class="song-title">${songInfo.name}</h2>
                <h5 class="artist-name">${songInfo.artists[0].name}</h5>
                <div id="song-info">
                    <span id="release-date">${songInfo.album.release_date}</span> • <span id="song-duration">${formatTime(songInfo.duration_ms)}</span> • <span class="album-name">${songInfo.album.name}</span>
                </div>
        ...
        majorDetails.innerHTML = `
            ...
            <div id="song-description">
                ...
                <p id="lyrics" class="items">
                    ${songInfo.lyrics || 'Song Description is unavailable at the moment.'}
                </p>
            </div>
            ${localStorage.getItem('user') != null ? 
                `<div id="download-button">
